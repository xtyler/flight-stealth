...
package flight.list
{
	 ...
	 */
	dynamic public class Collection extends Proxy implements IList, IExternalizable
	{
		/**
...
//		}
		 ...
		 */
//		public function add(item:Object, index:int):Object
//		{
//			if (index < 0) {
...
//		}
		...
		{
			return new Collection( adapter.concat() );
		}
		...
		{
			return get(name).apply(null, rest);
		}

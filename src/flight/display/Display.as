package flight.display
{
	...
	import flight.measurement.IMeasurablePercent;
	 ...
	 * Although most display classes in Stealth extend Display, it's not referenced directly by the framework itself. 
	 * In other words, you are not required to extend this class to use Stealth!
	 * 
	 * @alpha
	 */
